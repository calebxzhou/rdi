原因基本确定：ResourceScreen 现在用 client/ui/src/main/kotlin/calebxzhou/rdi/client/ui/screen/
ResourceScreen.kt:80 按 category 只组合当前 tab。切到别的 tab 后，旧 pane 会离开 composition，所以 pane
内部大量 remember 状态会丢，比如：

- RemoteModScreen 的搜索结果、loading、offset、totalHits 等在 client/ui/src/main/kotlin/calebxzhou/
  rdi/client/ui/screen/RemoteModScreen.kt:83

- RemoteModpackScreen 的列表、筛选、分页状态在 client/ui/src/main/kotlin/calebxzhou/rdi/client/ui/
  screen/RemoteModpackScreen.kt:89

- InstalledResourcePane 的选中包、配置编辑器、弹窗状态在 client/ui/src/main/kotlin/calebxzhou/rdi/
...
最小落地范围
第一步只改 client/ui/src/main/kotlin/calebxzhou/rdi/client/ui/screen/ResourceScreen.kt:50：
