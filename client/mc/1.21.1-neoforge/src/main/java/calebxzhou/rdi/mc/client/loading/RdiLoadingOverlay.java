...
public final class RdiLoadingOverlay extends LoadingOverlay {
    ...
    private static void drawTexture(
        ...
        buffer.addVertex(x0, y0, 0f).setUv(u0, v0).setColor(1f, 1f, 1f, alpha);
        buffer.addVertex(x1, y0, 0f).setUv(u1, v0).setColor(1f, 1f, 1f, alpha);
        buffer.addVertex(x1, y1, 0f).setUv(u1, v1).setColor(1f, 1f, 1f, alpha);
        buffer.addVertex(x0, y1, 0f).setUv(u0, v1).setColor(1f, 1f, 1f, alpha);
