package calebxzhou.rdi.earlydisplay.forge;
...
/** Forge 1.20.1 ImmediateWindowProvider adapter. */
public final class Forge20 implements ImmediateWindowProvider {
    ...
    private static final class Platform implements RdiDisplayPlatform {
        ...
        public Settings parse(String[] arguments) {
            ...
            var forgeVersion = parser.accepts("fml.forgeVersion").withRequiredArg().ofType(String.class);
            ...
            return new Settings(
                    ...
                    System.getenv("FML_EARLY_WINDOW_DARK") != null,
        ...
        public void updateProgress(String message) {
            net.minecraftforge.fml.loading.ImmediateWindowHandler.updateProgress(message);
        }
        ...
        public String fallbackLoadingOverlayClassName() {
            return "net.minecraftforge.client.loading.NoVizFallback";
        }
    }
}
