...
public record RErrorCode(String id, String info) {
    ...
    public static final RErrorCode NO_CRAFTING_TABLE = code("no_crafting_table", "no usable crafting table was found near the player.");
    public static final RErrorCode CRAFTING_OPEN_FAILED = code("crafting_open_failed", "the server could not open the crafting table menu.");
    ...
    public static final RErrorCode NO_PLACE_FACE = code("no_place_face", "/place could not find a non-air adjacent block face to click.");
    ...
    public static final RErrorCode MISSING_POS = code("missing_pos", "required pos query parameter is absent or blank.");
    public static final RErrorCode BAD_POS = code("bad_pos", "pos is not dim,x,y,z, dimension is empty, coordinates are not integers, or action x/y/z query values are invalid.");
    ...
    public static final RErrorCode BAD_LIMIT = code("bad_limit", "limit is not an integer or is outside 1..128.");
    public static final RErrorCode BAD_SLOT = code("bad_slot", "an inventory slot reference is invalid.");
    public static final RErrorCode BAD_SIDE = code("bad_side", "container side is not one of up, down, north, south, west, or east.");
    ...
    public static final RErrorCode BAD_CRAFTING_RADIUS = code("bad_crafting_radius", "radius for /crafting/open is not an integer or is outside 0..8.");
    ...
    public static final Map<String, RErrorCode> MAP = mapOf(List.of(
            METHOD_NOT_ALLOWED, NOT_FOUND, INTERNAL_ERROR, BAD_REQUEST, BAD_ACTION, ACTION_FAILED, PROMPTS_NOT_FOUND,
            ...
            NO_PLAYER, DIM_NOT_LOADED, BUSY_CONTAINER_OPEN, CARRIED_ITEM_NOT_EMPTY, NO_CRAFTING_TABLE,
            CRAFTING_OPEN_FAILED, MISSING_INGREDIENTS, RESULT_FULL, CRAFT_FAILED, CRAFT_TIMEOUT,
            TOO_FAR, NO_ITEM_HANDLER, TARGET_NOT_AIR, NO_PLACE_ITEM, NO_PLACE_FACE, PLACE_FAILED, BREAK_FAILED,
            PROTECTED, TOO_MANY_BLOCKS, MISSING_POS, BAD_POS, BAD_POSITIONS, BAD_BOX, MISSING_BLOCK_ID,
            ...
            BAD_RADIUS, BAD_LIMIT, BAD_SLOT, BAD_SIDE, SAME_SLOT, UNSUPPORTED_MERGE_RISK, BAD_COUNT,
            EMPTY_SOURCE, INCOMPATIBLE_TARGET, TARGET_FULL, BAD_CRAFTING_RADIUS, BAD_SHAPE, NO_MATCHING_RECIPE,
            MISSING_TEXT, MISSING_KEY, NO_BLOCK, NO_BLOCK_ENTITY, CHUNK_NOT_LOADED, SECTION_OUT_OF_RANGE,
            NO_ENTITY, NO_PLAYER_ENTITY, NO_LANGKEY
    ));
